                ...
                <el-col :span="7">
                    ...
                    <el-row>
                        <div style="margin-top: 3vh">
                            <dv-scroll-board :config="configDown" style="width:90%;height:36vh" class="swapper-item"/>
                        </div>
                    </el-row>
                ...
                <el-col :span="7">
                    <el-row>
                        <div class="first-item">
                            <dv-border-box-1 :color="['white', 'green']">
                                <div class="second_screen_a">
                                    <div ref="suffixChart" class="secon_chart"></div>
                                </div>
                            </dv-border-box-1>
                        </div>
                    </el-row>
                    <el-row>
                        <div class="second-item">
                            <dv-border-box-1 :color="['white', 'green']">
                                ...
                                <dv-capsule-chart :config="userConfig" style="width:70%;height:23vh" class="capsule-item"/>
                            </dv-border-box-1>
                        </div>
                    </el-row>
                    <el-row>
                        <div class="second-item">
                            <dv-border-box-1 :color="['white', 'green']">
                                <div class="second_screen_a">
                                    <div ref="typeChart" class="secon_chart"></div>
                                </div>
                            </dv-border-box-1>
                        </div>
                    </el-row>
